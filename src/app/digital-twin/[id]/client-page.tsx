// src/app/digital-twin/[id]/client-page.tsx
"use client";
...
export default function ClientPage({ patient }: ClientPageProps) {
  ...
  const [showRareDisorderInfoModal, setShowRareDisorderInfoModal] =
    useState(false);
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-white p-4 rounded-lg shadow-xl mb-6">
        <div className="flex items-center mb-4 sm:mb-0">
          <button
            onClick={() => setShowAboutTestModal(true)}
          ...
          <h1 className="text-xl font-bold text-gray-800">
            안녕하세요, {patient.lastName}
            {patient.firstName}님!
            <p className="text-sm font-normal text-gray-500">
              디지털 트윈 상세 정보. 현재 상태:{" "}
              <span className="text-blue-600">
                {DNA_STATUS_MAP[patient.dnaStatus]}
              </span>
            </p>
          </h1>
        </div>
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-gray-600 text-sm">
          <span className="flex items-center font-semibold text-gray-700">
            분석된 질환:{" "}
            {isNewPatientWithPendingDNA ? missingInfoText : "28594"}
          </span>
          <span className="flex items-center font-semibold text-gray-700">
            발견된 변이:{" "}
            {isNewPatientWithPendingDNA ? missingInfoText : "17950"}
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="text-gray-700 space-y-2 text-sm text-left">
              <p>
                <strong>나이:</strong> {patient.age || missingInfoText}
              </p>
              <p>
                <strong>키:</strong> {patient.height || missingInfoText}
              </p>
              <p>
                <strong>체중:</strong> {patient.weight || missingInfoText}
              </p>
              <p>
                <strong>인종:</strong> {patient.ethnicity || missingInfoText}
              </p>
              <p>
                <strong>직업:</strong> {patient.occupation || missingInfoText}
              </p>
            </div>
          </section>
          ...
          <section className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="text-gray-700 space-y-2 text-sm text-left">
              <p>
                <strong>운동:</strong> {missingInfoText}
              </p>
              <p>
                <strong>흡연:</strong> {missingInfoText}
              </p>
              <p>
                <strong>소금 섭취:</strong> {missingInfoText}
              </p>
              <p>
                <strong>음주:</strong> {missingInfoText}
              </p>
              <p>
                <strong>지방 섭취:</strong> {missingInfoText}
              </p>
            </div>
          </section>
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white p-6 rounded-lg shadow-lg flex items-start justify-between">
            ...
            <button
              onClick={() => setShowRareDisorderInfoModal(true)}
                  ...
                  <>
                    ...
                    <div className="flex flex-wrap gap-2 text-xs mt-2 space-x-3">
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-red-100 text-red-800">
                        <span className="w-2 h-2 bg-red-500 rounded-full mr-1"></span>{" "}
                        {koreanTerms.actionable}: 14
                      </span>
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full bg-blue-100 text-blue-800">
                        <span className="w-2 h-2 bg-blue-500 rounded-full mr-1"></span>{" "}
                        {koreanTerms.informative}: 31
                      </span>
                    </div>
                  </>
                )}
              ...
              <div>
                ...
                {isNewPatientWithPendingDNA ? (
                  ...
                  <>
                    ...
                    <div className="flex flex-wrap gap-2 text-xs mt-2 space-x-3">
                      <div className="flex items-center">
                        <span className="text-blue-600 font-semibold text-base mr-1">
                          8
                        </span>
...
const ChatIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M18 5v8a2 2 0 01-2 2h-5l-4 4v-4H2a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2zM6 9H4v2h2V9zm8-2H6v2h8V7zm0 4H6v2h8v-2z"
      clipRule="evenodd"
    />
  </svg>
);
