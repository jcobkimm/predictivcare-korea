...
'use client'; // 이 파일은 클라이언트 컴포넌트로 변경되어야 합니다 (필요 시).

// Image 컴포넌트를 사용하지 않으므로 임포트에서 제거합니다.
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <section className="bg-white p-8 rounded-lg shadow-md mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          [cite_start]프리딕티브 AI는 유전체(Genome)와 생활 습관(Nurture)의 데이터를 통합하여, 모든 사람이 더욱 행복하고 건강한 삶을 오랫동안 누릴 수 있도록 돕습니다. [cite: 1025-1029]
        </p>
      ...
      <section className="bg-white p-8 rounded-lg shadow-md mb-8">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          [cite_start]프리딕티브 AI는 질병 발생 후 치료하는 방식에서 벗어나, 데이터 기반의 건강 예측을 통해 질병을 예방하고 조기에 관리하는 사전 예방적 헬스케어를 지향합니다. [cite: 1030-1038]
